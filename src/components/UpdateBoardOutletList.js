        ...
        if(this.state.latitude===null || this.state.longitude===null) {
            ...
            fetch(global.mainserver+'/nearby_stores/', {
                ...
                if(this.state.response_status === 200){
                    ...
                    this.state.dataBrandName = json_data.outlets_list['brands']["Ajay Electric"]
                    ...
                    //Checking if outlet list is empty
                    let outletList = json_data.outlets_list['outlets'].length
                    if (outletList === 0){
                        Alert.alert("No registered outlet around your location!")
                    }else{
    ...
    render() {
        return (
            <View style={styles.container}>
                <LinearGradient colors={['#570be2', '#b822c7']} style={[styles.box, styles.box1]}>
                    ...
                    style={styles.btn}>
                        <Text style={styles.btnText}>Update Outlet List</Text>
                    </TouchableOpacity>
                </LinearGradient>
