...
export default class store_page extends Component {
    ...
    */
    static navigationOptions = ({navigation}) =>({
        headerTitle: <Image style={{ width: 70, height: 25 }} source={require('../images/home.png')} 
                            resizeMode='contain'/>,
        headerLeft: null,			
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity
                    onPress={()=> this.props.navigation.navigate('audit_NewStore')}
                    style={[styles.btn1,styles.box, styles.box1]}>
                    <Image style={{width: 90, height: 70, marginVertical:10}}
                           source = {require('../images/add-circular-outlined-button.png')} 
                           resizeMode='contain'/>
                    <LinearGradient colors={['#0200ff', '#00e9ff']} style={styles.btn}>
                        <Text style={styles.btnText}>Audit New Store</Text>
                    </LinearGradient>
                </TouchableOpacity>
                

                <TouchableOpacity
                    onPress={()=> this.props.navigation.navigate('doc_shelf')}
                    style={[styles.btn2, styles.box, styles.box2]}>
                    <Image style={{width: 90, height: 70, marginVertical:10}}
                           source = {require('../images/circular-down-arrow-button.png')} 
                           resizeMode='contain'/>
                    <LinearGradient colors={['#0200ff', '#00e9ff']} style={styles.btn}>
                        <Text style={styles.btnText}>Check Audit Status</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
